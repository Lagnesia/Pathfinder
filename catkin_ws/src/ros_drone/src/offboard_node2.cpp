...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber gpsX_sub = nodeHandle.subscribe<std_msgs::Float64>("ros_drone/gps_X", 10, cbMoveX);
    ros::Subscriber gpsY_sub = nodeHandle.subscribe<std_msgs::Float64>("ros_drone/gps_Y", 10, cbMoveY);
    ros::Subscriber gpsZ_sub = nodeHandle.subscribe<std_msgs::Float64>("ros_drone/gps_Z", 10, cbMoveZ);
