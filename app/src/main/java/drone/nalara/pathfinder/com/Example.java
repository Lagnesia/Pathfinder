 ...
 * 
 */
package drone.nalara.pathfinder.com;

import drone.nalara.pathfinder.com.message.Clock;
import drone.nalara.pathfinder.com.message.Log;
import drone.nalara.pathfinder.com.rosapi.message.Empty;
import drone.nalara.pathfinder.com.rosapi.message.GetTime;
import drone.nalara.pathfinder.com.rosapi.message.MessageDetails;
import drone.nalara.pathfinder.com.rosapi.message.Type;
...
public class Example {
    ...
    public static void testService(ROSBridgeClient client) {
        try {
            ...
            Service<drone.nalara.pathfinder.com.rosapi.message.Service, Type> serviceTypeService =
                    new Service<drone.nalara.pathfinder.com.rosapi.message.Service, Type>("/rosapi/service_type",
                            drone.nalara.pathfinder.com.rosapi.message.Service.class, Type.class, client);
            serviceTypeService.verify();
            String type = serviceTypeService.callBlocking(new drone.nalara.pathfinder.com.rosapi.message.Service("/rosapi/service_response_details")).type;

            Service<Type, MessageDetails> serviceDetails =
                    new Service<Type, MessageDetails>("/rosapi/service_response_details",Type.class, MessageDetails.class, client);
            serviceDetails.verify();
            //serviceDetails.callBlocking(new Type(type)).print();

            drone.nalara.pathfinder.com.Topic<Log> logTopic =
                    new drone.nalara.pathfinder.com.Topic<Log>("/rosout", Log.class, client);
            logTopic.verify();
    ...
    public static void testTopic(ROSBridgeClient client) {
        drone.nalara.pathfinder.com.Topic<Clock> clockTopic = new drone.nalara.pathfinder.com.Topic<Clock>("/clock", Clock.class, client);
