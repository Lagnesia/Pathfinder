 ...
 * 
 */
package drone.nalara.pathfinder.com.rosbridge;

import drone.nalara.pathfinder.com.ROSClient;
import drone.nalara.pathfinder.com.Service;
...
import drone.nalara.pathfinder.com.rosapi.message.Nodes;
import drone.nalara.pathfinder.com.rosapi.message.Services;
import drone.nalara.pathfinder.com.rosapi.message.Topic;
import drone.nalara.pathfinder.com.rosapi.message.Topics;
import drone.nalara.pathfinder.com.rosapi.message.Type;
import drone.nalara.pathfinder.com.rosapi.message.TypeDef;
import drone.nalara.pathfinder.com.rosbridge.implementation.ROSBridgeWebSocketClient;
import drone.nalara.pathfinder.com.rosbridge.operation.Operation;
    ...
    private String getServiceType(String service) throws InterruptedException {
        Service<drone.nalara.pathfinder.com.rosapi.message.Service, Type> serviceTypeService =
                new Service<drone.nalara.pathfinder.com.rosapi.message.Service, Type>("/rosapi/service_type",
                        drone.nalara.pathfinder.com.rosapi.message.Service.class, Type.class, this);
        return serviceTypeService.callBlocking(new drone.nalara.pathfinder.com.rosapi.message.Service(service)).type;
    }
