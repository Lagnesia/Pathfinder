package drone.nalara.pathfinder.net.xxhong.rosclient.ui;
...
public class NodesActivity extends Activity {
    ...
    class NodeListAdapter extends BaseExpandableListAdapter {
        TextView getTextView() {
            AbsListView.LayoutParams lp = new AbsListView.LayoutParams(ViewGroup.LayoutParams.FILL_PARENT,getResources().getDimensionPixelSize(R.dimen.list_height));
